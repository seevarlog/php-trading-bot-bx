...
class CandleManager extends Singleton
{
    ...
    public function getTrendValue(Candle $candle_1m)
    {
        ...
        $trend_value_30m = $trend_value_30m * 2.5;
        $trend_value_60m = $trend_value_60m * 4;
//        $trend_value_240m = $trend_value_240m * 5.5;
//        $trend_value_1day = $trend_value_1day * 4;
//        $trend_value_1week = $trend_value_1week * 2.5;

        $trend_value_30m = 0;
        $trend_value_240m = $trend_value_240m * 0;
        $trend_value_1day = $trend_value_1day * 0;
        $trend_value_1week = $trend_value_1week * 0;

        return ($trend_value_30m + $trend_value_1day + $trend_value_60m + $trend_value_240m + $trend_value_1week);
    }
